...
const aiErrorCodes = ['AI_INVALID_API_KEY', 'AI_INVALID_MODEL', 'AI_UPSTREAM_UNAVAILABLE'];
const analyticsErrorCodes = ['ANALYTICS_NOT_CONNECTED', 'ANALYTICS_UNAVAILABLE'];
const logsErrorCodes = ['LOGS_AWS_NOT_CONFIGURED', 'LOG_NOT_FOUND'];
...
const billingErrorCodes = ['BILLING_INSUFFICIENT_BALANCE'];
...
const docsErrorCodes = ['DOCS_NOT_FOUND'];
const functionErrorCodes = [
    'FUNCTION_ALREADY_EXISTS',
    'FUNCTION_DEPLOYMENT_NOT_FOUND',
    'FUNCTION_NOT_FOUND',
];
const scheduleErrorCodes = ['SCHEDULE_INVALID_CRON', 'SCHEDULE_NOT_FOUND'];
...
const secretErrorCodes = ['SECRET_ALREADY_EXISTS', 'SECRET_NOT_FOUND'];
...
//# sourceMappingURL=error-codes.schema.js.map